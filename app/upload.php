<?php
	...
	// wyslij emaila do typa z potwierdzeniem
	// wyslij emaila do operatora
	...
	$mail->msgHTML('<p>Potwierdzamy wzięcie udziału w konkursie</p>');
	$mail->AltBody = 'Potwierdzamy wzięcie udziału w konkursie';
	$mail->send();
	...
	$mail2->Subject = "JAKIS TYP WZIĄŁ UDZIAŁ W KONKURSIE";
	$mail2->msgHTML('<p>ZIOMEK WZIĄŁ UDZIAŁ W KONKURSIE <a href=' . $fileUrl  . '>' . $fileUrl . '</a></p>');
	$mail2->send();
